...
<div class="content mt-3 col-sm-10" style="margin: 65px">
            	<div class="animated fadeIn">
					...
					<td>					
					<a role="button" onclick="ApproveData('${a.id}')" title="Approve"><i class="fa fa-check" style="font-size:24px;color:#333333"></i></a>
					&nbsp;&nbsp;&nbsp;
					<a role="button" onclick="DeclineData('${a.id}')" title="Decline"><i class="fa fa-times" style="font-size:24px;color:#333333"></i></a>
					&nbsp;&nbsp;&nbsp;
					<a href="#" title="Downlaod"><i class="fa fa-arrow-circle-o-down" style="font-size:24px;color:#333333"></i></a>
                  	</td>
