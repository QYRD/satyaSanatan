...
<html lang="en">
 ...
 <link href="https://fonts.googleapis.com/css?family=Quicksand" rel="stylesheet">
  ...
  <head><title>Accepted Files</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <script type="text/javascript">
 	function DeclineData(id){
 		...
 		$.ajax({
 			...
 			alert("Declined!"),
 			windows.location='showDeclinedFiles';
 			},
...
<body>
    <table id="bootstrap-data-table" class="table table-striped table-bordered" border="1">
                    ...
                    <td>${a.topic}</td>
					<td>					
                  	<input value="Decline" onclick="DeclineData('${a.id}')" type="submit" id="btndcln" class="btn btn-info"></td>
