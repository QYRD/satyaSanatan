			...
			<div class="col-sm-5">
				<div class="cate-head col-sm-12">
					<div class="ved-categ col-md-12" align="center">
						<h2>Vedas</h2>
						<p>“The Hindus have received their religion through revelation, the Vedas. They hold that the Vedas are without beginning and without end. It may sound
ludicrous to this audience, how a book can be without beginning or end. But by the Vedas no books are meant.</p>
			...
			<div class="col-sm-5">
				<div class="cate-head1 col-sm-12">
					<div class="ved-categ col-sm-12">
						<h2>Upanishad</h2>
						<p>“In the whole world there is no study so beneficial and so elevating as the Upanishad. It has been the solace of my life and will be solace of my death”. “This life of yours which you are living is not merely apiece of this entire
existence, but in a certain sense the whole; only this whole is not so constituted that it can be surveyed in one single glance.</p>
						<a href="#" class="btn btn-primary"> Read Now</a>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-5">
				<div class="cate-head2 col-sm-12">
					<div class="ved-categ col-sm-12">
						<h2>Itihas</h2>
						<p>“That year will always remain a dear and cherished memory; it was the first time I had the opportunity to read the great sacred poem of India, the divine
Ramayana. If anyone has lost the freshness of emotion, let him drink a long draught of life, and youth from that deep chalice.”</b></p>
						<a href="#" class="btn btn-primary"> Read Now</a>
					</div>
				</div>
			</div>
